...
class OrderLoadStateViewHolder(
    ...
    companion object {
        fun create(parent: ViewGroup, retry: () -> Unit): OrderLoadStateViewHolder {
            val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.order_load_state_footer_view_item, parent, false)
            return OrderLoadStateViewHolder(view, retry)
        }
    }
}